      ...
      <div className="relative w-full">
        ...
        <BackgroundBeamsWithCollision className="grid h-fit lg:h-[940px] bg-transparent border-none !w-full" >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 max-w-[1400px] gap-5 mx-auto px-5 md:px-10">
            <div className="hover:shadow-lg shadow-md shadow-teal-500/50 duration-300 transition-all bg-[#0f0f0f]/80 border  hover:border-primary rounded-2xl px-8 py-6 w-full sm:w-[300px] text-primary text-center space-y-2 grid h-max text-5xl font-bold text-lime-400 tracking-wide"><span><NumberTicker className="text-primary" value={2} />+</span> <span className="text-sm text-neutral-300">Years of Experience</span></div>
            <div className="hover:shadow-lg shadow-md shadow-teal-500/50 duration-300 transition-all bg-[#0f0f0f]/80 border  hover:border-primary rounded-2xl px-8 py-6 w-full sm:w-[300px] text-primary text-center space-y-2 grid h-max text-5xl font-bold text-lime-400 tracking-wide"><span><NumberTicker className="text-primary" value={10} />+</span> <span className="text-sm text-neutral-300">Projects Completed</span></div>
